            ...
            if (commandSender instanceof Player) {
                ...
                if (args.length == 0 || args[0].equalsIgnoreCase("help")) {
                    if (player.hasPermission("br.help")) {
                        ...
                        commandSender.sendMessage(ChatColor.GOLD + "/bounty help" + ChatColor.WHITE + " displays commands");
                        if (player.hasPermission("br.list")) {
                            commandSender.sendMessage(ChatColor.GOLD + "/bounty list" + ChatColor.WHITE + " lists all available bounties");
                        }
                        if (player.hasPermission("br.setbounty")) {
                ...
                if (args[0] != null) {
                    ...
                    if (args[0].equalsIgnoreCase("remove")) {
                        if (player.hasPermission("br.removebounty")) {
                    ...
                    if (args[0].equalsIgnoreCase("increase")) {
                        if (player.hasPermission("br.increasebounty")) {
                    ...
                    if (args[0].equalsIgnoreCase("updatesql")) {
                        if (player.hasPermission("br.updatesql")) {
                            if (settings.isUsingMySQL()) {
                                settings.getPlugin().reloadConfig();
